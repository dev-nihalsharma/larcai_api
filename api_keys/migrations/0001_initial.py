# Generated by Django 5.2.2 on 2025-10-24 21:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entity', models.ForeignKey(blank=True, help_text='Optional secondary user or entity related to this API key.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='entity_api_keys', to=settings.AUTH_USER_MODEL)),
                ('owner', models.ForeignKey(help_text='The user who owns this API key.', on_delete=django.db.models.deletion.CASCADE, related_name='user_api_keys', to=settings.AUTH_USER_MODEL)),
            ],
            options={
